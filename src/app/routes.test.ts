...
describe("route integration smoke", () => {
  it.each(["page.tsx", "explore/page.tsx", "search/page.tsx", "content/[id]/page.tsx", "scholars/[slug]/page.tsx", "topics/[slug]/page.tsx", "questions/[id]/page.tsx", "(private)/ask/[step]/page.tsx", "(private)/notifications/page.tsx", "(private)/admin/moderation/page.tsx"])("ships the P0 route %s", route => { expect(readFileSync(resolve(app, route), "utf8").length).toBeGreaterThan(20); });
