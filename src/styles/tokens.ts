export const tokens = {
  color: { canvas: "--ds-color-canvas", surface: "--ds-color-surface", text: "--ds-color-text", textMuted: "--ds-color-text-muted", border: "--ds-color-border", primary: "--ds-color-primary", accent: "--ds-color-accent", danger: "--ds-color-danger", warning: "--ds-color-warning", success: "--ds-color-success", focus: "--ds-color-focus" },
